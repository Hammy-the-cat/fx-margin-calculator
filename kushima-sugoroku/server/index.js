...
// CORS設定 - 強制的にすべて許可
app.use(cors({
  origin: '*', // すべてのオリジンを明示的に許可
  methods: ['GET', 'POST', 'OPTIONS'],
  allowedHeaders: ['Content-Type', 'Authorization'],
  credentials: false // セキュリティのため一時的に無効
}));
...
server.listen(PORT, HOST, () => {
  console.log(`🎮 Kushima Sugoroku Server running on ${HOST}:${PORT}`);
  console.log(`🌐 Health check: http://localhost:${PORT}/health`);
  console.log(`🌐 Public URL: https://kushima-sugoroku-production.up.railway.app`);
});